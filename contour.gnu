...
#set palette defined (0 "#008080ff", 0.2 "yellow", 1.0 "red")
set palette defined (0 "#00c0c0", 0.2 "yellow", 1.0 "red")
...
#set out "contour1.eps"
#set colorbox user origin 0.17,0.55 size 0.025,0.3

#set label "t = 1.0 t_{rel}" at 3,33,0.3
#splot "fpMax30np600p01E25zMax20nz400v4.1.dat" u 1:2:3 index 10 w pm3d noti

unset colorbox

#set out "contour2.eps"

#set label "t = 2.0 t_{rel}" at 3,33,0.3
#splot "fpMax30np600p01E25zMax20nz400v4.1.dat" u 1:2:3 index 20 w pm3d noti

#set out "contour5.eps"

#set label "t = t_{br}(E)=5 t_{rel}" at 3,33,0.3
#splot "fpMax30np600p01E25zMax20nz400v4.1.dat" u 1:2:3 index 50 w pm3d noti

set out "contour8.eps"

set label "t = 8.0 t_{rel}" at 3,33,0.3
splot "fpMax30np600p01E25zMax20nz400v4.1.dat" u 1:2:3 index 80 w pm3d noti
