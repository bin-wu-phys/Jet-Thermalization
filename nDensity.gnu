...
set xlabel "z/t_{rel}"
set ylabel "number desity"


plot "fpMax30np600p01E25zMax20nz400v4.1.1den.dat" u 1:2 index 10 w l ls 1 ti "t=1.0t_{rel}",\
"fpMax30np600p01E25zMax20nz400v4.1.1den.dat" u 1:2 index 20 w l ls 2 ti "t=2.0t_{rel}",\
"fpMax30np600p01E25zMax20nz400v4.1.1den.dat" u 1:2 index 50 w l ls 3 ti "t=5.0t_{rel}",\
"fpMax30np600p01E25zMax20nz400v4.1.1den.dat" u 1:2 index 80 w l ls 4 ti "t=8.0t_{rel}"
#pause -1
reset
set term x11
